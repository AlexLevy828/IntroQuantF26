---
title: "CommunityDiversityIndices_Clusters_2026"
format: html
author: Amy King-Henry
datemodified: Sept 10, 2026
editor: visual
---
...
```{r}
Freshies <- read.csv(file = "Demo Data Files/Freshwater_Invertebrates.csv")

glimpse(Freshies)
load("Demo Data Files/S4E2e.RData")
```
...
library(vegan)
diversity(psa, index = "simpson", MARGIN = 2)
...
bind_cols(vec,shan_div, simp_div,sprich) |> 
  rename(Site = `...1`, Shannon = `...2`, Simpson = `...3`, SpRich = `...4`) |>   separate(Site, into = c("Null","site", "UpperLower", "Rep"), sep = "")
```
